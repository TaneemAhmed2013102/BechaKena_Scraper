        ...
        <div className="row">
          <div className="col-lg-3 mb-3">
            ...
            <ul className="list-unstyled small text-dark">
              <li className="mb-2">Designed and built with all the love in the world by the <a href="/docs/5.0/about/team/" style={{color: "black", textDecoration: "none"}}>HECTIC ROBO Team</a>.</li>
          ...
          <div className="col-6 col-lg-3 offset-lg-1 mb-3">
            ...
            <ul className="list-unstyled">
              { listOfLocations.map(e => <li className="mb-2"><a style={{color: "black", textDecoration: "none"}} href="/">{e.title}</a></li>) }
            </ul>
          </div>
          <div className="col-6 col-lg-3 mb-3">
            <h5 className="h-text">Popular Categories</h5>
            <ul className="list-unstyled">
              { listOfCategories.map(e => <li className="mb-2"><a style={{color: "black", textDecoration: "none"}} href="/">{e.title}</a></li>) }
            </ul>
          </div>
          <div className="col-6 col-lg-2 mb-3">
            ...
            <ul className="list-unstyled d-flex">
              ...
              <li className="mb-2"><a style={{color: "black", textDecoration: "none"}} href="https://m.facebook.com/login/?locale=en_GB">
                <i className="me-3">
                  <FontAwesomeIcon icon={faFacebook} />
                </i>
              </a></li>
              <li className="mb-2"><a style={{color: "black", textDecoration: "none"}} href="https://www.instagram.com/accounts/login/?__coig_restricted=1">
                <i className="me-3">
                  <FontAwesomeIcon icon={faInstagram} />
                </i>
              </a></li>
              <li className="mb-2"><a style={{color: "black", textDecoration: "none"}} href="https://twitter.com/i/flow/login">
                <i className="me-3">
                  <FontAwesomeIcon icon={faTwitter} />
                </i>
              </a></li>
              <li className="mb-2"><a style={{color: "black", textDecoration: "none"}} href="https://www.linkedin.com/login">
                <i className="me-3">
